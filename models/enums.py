...
class Models(Enum):
    ...
    WU_WITHOUT_FLOATING_BASE_OFFSET_TEMPLATE_COPY = Path(__file__).parent.__str__() + "/wu_converted_definitif_without_floating_base_template_xyz_offset_copie.bioMod"
